...
use Sm\FilterProducts\Block\FilterProducts;
...
class Data extends AbstractHelper
{
	...
	public function __construct(
		...
		\Sm\FilterProducts\Block\FilterProducts $block
	){
	...
	private function getProductImages($product, $_config, $prefix = 'img')
	{
		...
		$_placeholder = ($placeholder != '' && strpos($placeholder, 'http') !== false) ? $placeholder :  $this->_block->getViewFileUrl('Sm_FilterProducts::images/nophoto.jpg');
	...
	public function _getImageThumbnail($image){
		...
		$placeholder = $this->_block->getViewFileUrl('Sm_FilterProducts::images/nophoto.jpg');
